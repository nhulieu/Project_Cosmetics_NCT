                ...
                <div class="col-md-3">
                    <nav class="navbar bg-light">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#new-arrival"><i class="fa fa-plus-square"></i>New
                                    Arrivals</a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#fashion-beauty"><i
                                        class="fa fa-cart-plus"></i>Accessories</a>
                            </li>
                        </ul>
                    </nav>
                </div>
