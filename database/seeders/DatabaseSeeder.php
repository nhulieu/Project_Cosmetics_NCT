...
class brandSeeder extends Seeder
{
    public function run()
    {
        DB::table('brand')->insert([
            ...
            ["name" => "Maybelline New Yor", "slogan" => "Maybe she’s born with it. maybe it’s Maybelline", "logo" => "img/brand_logo/Bioré_logo_logotype.png"],
...
class imageSeeder extends Seeder
{
    public function run()
    {
        DB::table('image')->insert([
            ...
            ["product_id" => "4", "path" => "img/Product_Photo/4. Maybelline/4.png"],
            ...
            ["product_id" => "8", "path" => "img/Product_Photo/8. L'absolu/3.webp"],
            ...
            ["product_id" => "14", "path" => "img/Product_Photo/14. Nivea Lip/3.jpeg"],
            ...
            ["product_id" => "17", "path" => "img/Product_Photo/17. SENKA/1.png"],
            ["product_id" => "17", "path" => "img/Product_Photo/17. SENKA/2.jpg"],
            ["product_id" => "17", "path" => "img/Product_Photo/17. SENKA/3.webp"],
...
class categorySeeder extends Seeder
{
    public function run()
    {
        DB::table('category')->insert([
            ...
            ["name" => "MAKEUP TOOLS", "DESCRIPTION" => ""],
            ["name" => "GEL CLEASING", "DESCRIPTION" => ""],
            ["name" => "EXFOLIATE FACIAL SKIN", "DESCRIPTION" => ""],
            ["name" => "TONER", "DESCRIPTION" => ""],
            ["name" => "SERUM", "DESCRIPTION" => ""],
...
Ingredient : WATER (AQUA), PEG-6 CAPRYLIC/CAPRIC GLYCERIDES, CUCUMIS SATIVUS (CUCUMBER) FRUIT EXTRACT, MANNITOL, XYLITOL, RHAMNOSE, FRUCTOOLIGOSACCHARIDES, PROPYLENE GLYCOL, DISODIUM EDTA, CETRIMONIUM BROMIDE. ", "status" => "1", "price" => "450", "discount" => "11", "quantity" => "6", "tax" => "25", "feature" => "feature 2", "mark" => "2"],
...
Ingredient : Water, Ethylhexyl Methoxycinnamate, Butylene Glycol, Diphenylsiloxy Phenyl Trimethicone, Titanium Dioxide, Diethylamino Hydroxybenzoyl Hexyl Benzoate, Sodium Hyaluronate, Magnesium Ascorbyl Phosphate, Passiflora Edulis Fruit Extract, Hydrolyzed Prunus Domestica, Rosa Roxburghii Fruit Extract, Bis-PEG-18 Methyl Ether Dimethyl Silane, Methyl Methacrylate/Glycol Dimethacrylate Crosspolymer, Bis-Ethylhexyloxyphenol Methoxyphenyl Triazine, Acrylates Copolymer, Polysorbate 60, Acrylates/C10-30 Alkyl Acrylate Crosspolymer, Triethanolamine, Ammonium Acryloyldimethyltaurate/VP Copolymer, Silica, PEG-12 Dimethicone, Polystyrene, Polyvinyl Alcohol, Disodium EDTA, Xantham Gum, Alumina, Butylated Hydroxytoluene, Polyglyceryl-2 Triisostearate, Synthetic Fluorphlogopite, Tin Oxide, CI 73360, CI 42090, Fragrance.", "status" => "1", "price" => "140", "discount" => "12", "quantity" => "1", "tax" => "05", "feature" => "feature 3", "mark" => "3"],
...
[+/- MAY CONTAIN CI 77891 / TITANIUM DIOXIDE, CI 77491, CI 77492, CI 77499 / IRON OXIDES ] G854042", "status" => "1", "price" => "173", "discount" => "13", "quantity" => "2", "tax" => "05", "feature" => "feature 4", "mark" => "4"],
...
Ingredient : Trimethylsiloxysilicate, Dimethicone, Polyethylene, Acrylates/Stearyl Acrylate/Dimethicone Methacrylate Copolymer, Iron Oxide Black (CI 77499), Mica (CI 77019), Caprylyl Glycol, Glyceryl Caprylate, Ceresin, Isohexadecane, Carnauba Wax, Synthetic Wax, Methyl Trimethicone, Triethoxycaprylylsilane", "status" => "1", "price" => "140", "discount" => "14", "quantity" => "2", "tax" => "05", "feature" => "feature 5", "mark" => "5"],
            ["name" => "Makeup Voluminous Lash Paradise Waterproof Mascara", "category_id" => "22", "brand_id" => "2", "description" => "Volumizing And Lengthening Mascara: This volumizing and lengthening mascara delivers a full lash fringe that’s feathery soft, with no flaking, no smudging, and no clumping; Just voluptuous volume and intense length
...
Ingredient :Water, Titanium Dioxide (CI 77891), Cyclopentasiloxane, Methyl Trimethicone , Ethylhexyl Methoxycinnamate, etc.", "status" => "1", "price" => "808", "discount" => "0", "quantity" => "5", "tax" => "05", "feature" => "feature 7", "mark" => "7"],
            ["name" => "L'absolu Rouge Cream Lipstick - 132 Caprice", "category_id" => "1", "brand_id" => "12", "description" => "Lancôme L'Absolu Rouge Lipstick Cream - 132 Caprice is a elegant and classic lipstick that keeps the lips beautiful and ready to kiss all day. This lipstick not only gives a beautiful look, but also works nurturing . The creamy and silky soft formula is enriched with hyaluronic acid, which adds a lot of moisture . In addition, the formula also contains Pro-Xylane, which is Lancôme's unique molecule, which means that the lips continue to stay supple, smooth and full .
...
", "status" => "1", "price" => "900", "discount" => "0", "quantity" => "6", "tax" => "05", "feature" => "feature 8", "mark" => "5"],
...
", "status" => "1", "price" => "50", "discount" => "0", "quantity" => "4", "tax" => "05", "feature" => "", "mark" => "4"],
            ["name" => "VITALUMIÈRE AQUA - CHANEL", "category_id" => "17", "brand_id" => "7", "description" => "With a soft, water-light texture and light-to-medium coverage, the tiniest drop of this hybrid fluid foundation creates a natural-looking glow. Skin looks refined and feels refreshed, for an exquisite makeup experience.
...
", "status" => "1", "price" => "50", "discount" => "0", "quantity" => "3", "tax" => "05", "feature" => "", "mark" => "3"],
...
Ingredient :  Aqua / Water, Glycerin, Alcohol Denat, Caprylic/Capric Triglyceride, Mannose, Carbomer, Sodium Pca, Salicylic Acid, Sodium Hydroxide, Sodium Hyaluronate, Limnanthes Alba Seed Oil / Meadowfoam Seed Oil, Caprylyl Glycol, Acrylates/C10-30 Alkyl Acrylate Crosspolymer, Parfum / Fragrance.", "status" => "1", "price" => "155", "discount" => "0", "quantity" => "15", "tax" => "05", "feature" => "", "mark" => "3"],
            ["name" => "Bioré Sunscreen Lotion SPF 50+/PA++++ 30ml
UV Face Mil", "category_id" => "5", "brand_id" => "7", "description" => "Oily skin girls are often afraid to apply sunscreen because they do not like the greasy, secretive feeling that sunscreen brings. In addition, when sweat is washed away, sunscreen is no longer effective, so many women skip this extremely important skin protection step. Then Bioré's Face Milk SPF50+/PA++++ - a specialized sunscreen for oily skin girls is the choice you cannot ignore.
...
", "status" => "1", "price" => "50", "discount" => "0", "quantity" => "5", "tax" => "05", "feature" => "", "mark" => "4"],
            ["name" => "Bourjois Lipstick Pink 12 Beau Brun 7.7ml
Rouge Edition Velvet", "category_id" => "2", "brand_id" => "9", "description" => "Bourjois Rouge Edition Velvet Lipstick is a lipstick line that is praised by famous bloggers around the world as a liquid lipstick – creamy lipstick – “The Best Liquid Lipstick”! Bourjois lipstick palette is beautiful, delicate, diverse in application colors, has a light and velvety texture, many outstanding colors make you feel natural and comfortable, helping to bring makeup results unexpected and durable for many hours.
...
Cocamide Mea:
Keratin:", "status" => "2", "price" => "550", "discount" => "0", "quantity" => "3", "tax" => "05", "feature" => "", "mark" => "5.5"]
