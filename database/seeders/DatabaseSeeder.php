...
["name"=>"Makeup Voluminous Lash Paradise Waterproof Mascara","category_id"=>"22","brand_id"=>"20","description"=>"Volumizing And Lengthening Mascara: This volumizing and lengthening mascara delivers a full lash fringe that’s feathery soft, with no flaking, no smudging, and no clumping; Just voluptuous volume and intense length
...
Body Milk","category_id"=>"5","brand_id"=>"3","description"=>"Hatomugi Body Milk Body Milk is a body lotion from the Japanese cosmetic brand Hatomugi, with ingredients extracted from willow seeds to maintain skin moisture, bring moist skin, soften skin. and effective whitening.
